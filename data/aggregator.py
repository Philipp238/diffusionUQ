...
def aggregate():
    ...
    for name in datasets:
        ...
        file_name = f"results/NDP/{name}"
        # file_name = f"results_{name}_CARD_sampling_and_epochs_likeCARD_2000epochs_3n_comp"
        # file_name = f"results_{name}_CARD_sampling_and_epochs_likeCARD_10000epochs"
